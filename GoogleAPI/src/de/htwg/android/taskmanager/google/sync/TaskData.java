...
//		generateData();
	...
	private LocalTaskLists generateData() throws MarshallingException {
	...
	public static void main(String[] args) throws MarshallingException {
		LocalTaskLists taskLists = new TaskData().getAllTasklists();
		for (Iterator iterator = taskLists.getListOfTaskList().iterator(); iterator.hasNext();) {
			LocalTaskList type = (LocalTaskList) iterator.next();
			System.out.println(type.getInternalId());
		}
	}
}
