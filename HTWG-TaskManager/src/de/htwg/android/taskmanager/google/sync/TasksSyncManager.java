...
import de.htwg.android.taskmanager.google.local.LocalTaskManager;
...
public class TasksSyncManager {
	...
	public TasksSyncManager() {
		taskManager = new LocalTaskManager();
		syncHelper = new TasksSyncHelper(taskManager);
	}

	// /**
	// * Searchs the same remote tasklist for the given localTaskList. The
	// search
	...
	// */
	// private TaskList searchRemoteTaskList(List<TaskList> remote,
	// de.htwg.android.taskmanager.backend.entity.LocalTaskList localTaskList) {
	...
	// * @throws IOException
	// */
	// void sync(List<de.htwg.android.taskmanager.backend.entity.LocalTaskList>
	// local, List<TaskList> remote) throws IOException {
	// for (de.htwg.android.taskmanager.backend.entity.LocalTaskList
	// localTaskList : local) {
